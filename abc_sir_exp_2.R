...
epsilon <- 573809.0 # Epsilon value
...
#res[1,] <- c(0.4953251, 6.124995, 2.760476, 0.4562142, 575745.6)
res[1,] <- c(0.5084723, 0.2646255, 9.765967, 0.4681061, 573809.0)
...
ggplot(points, aes(x=Day)) + 
  ...
  geom_point(aes(y = sir_exp, color = "SIR Exponential Model", shape = "SIR Exponential Model"), size = 6) +
...
plot(ts,alpha_1 + alpha_2 * exp(-alpha_3*ts),type = 'o', xlab = 'Day', ylab = 'Transmission Rate')
